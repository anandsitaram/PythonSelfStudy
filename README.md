...
This repo is a running log of core Python concepts practiced from scratch — data types, operators, and language basics — as part of a broader shift from manual/automation QA toward Python-based test automation and AI-assisted engineering.
